...
from medusa.service.grpc import medusa_pb2 as medusa__pb2
...
class MedusaStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReloadConfig = channel.unary_unary(
                '/Medusa/ReloadConfig',
                request_serializer=medusa__pb2.ReloadConfigRequest.SerializeToString,
                response_deserializer=medusa__pb2.ReloadConfigResponse.FromString,
                )
...
def add_MedusaServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReloadConfig': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=medusa__pb2.ReloadConfigRequest.FromString,
                    response_serializer=medusa__pb2.ReloadConfigResponse.SerializeToString,
            ),
    }
...
class Medusa(object):
    ...
    def ReloadConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Medusa/ReloadConfig',
            medusa__pb2.ReloadConfigRequest.SerializeToString,
            medusa__pb2.ReloadConfigResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
